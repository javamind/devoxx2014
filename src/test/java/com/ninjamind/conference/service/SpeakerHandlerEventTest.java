...
/**
 * Classe de test de {@link SpeakerService}
 *
 * @author EHRET_G
 */
public class SpeakerHandlerEventTest {
    ...
    /**
     * Test de {@link SpeakerService#createSpeaker(com.ninjamind.conference.events.speaker.CreateSpeakerEvent)
    ...
    /**
     * Test de {@link SpeakerService#updateSpeaker(com.ninjamind.conference.events.speaker.UpdateSpeakerEvent)}
     * cas ou argument null
     */
    @Test(expected = NullPointerException.class)
    ...
    /**
     * Test de {@link SpeakerService#deleteSpeaker(com.ninjamind.conference.events.speaker.DeleteSpeakerEvent)}
     * cas nominal
     */
    @Test
    ...
    /**
     * Test de {@link SpeakerService#getSpeaker(com.ninjamind.conference.events.speaker.ReadSpeakerRequestEvent)}
     * cas nominal
     */
    @Test
